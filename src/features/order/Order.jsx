...
// useParams钩子只能用在组件内，loader不是组件，而是一个普通函数
// 新版React Router里，当 loader 函数和 createBrowserRouter() 里的 loader 绑定时，默认会传入 { params } 参数
// 可以在 loader 函数中通过 params 获取 /order/:orderId 中的动态 orderId
